...
public class ScriptGenerator {
  ...
  private void afterPropertiesSet(){
    Assert.hasText(c4FileLocation, "File Location cannot be empty");
    Assert.hasText(targetSoftwareSystemName, "TargetSoftwareSystemName cannot be empty");
    Assert.hasText(outputFileLocation, "outputFileLocation cannot be empty");
    Assert.notNull(scriptRenderer, "ScritRenderer cannot be null");
